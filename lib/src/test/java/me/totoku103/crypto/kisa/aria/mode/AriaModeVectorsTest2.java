...
import me.totoku103.crypto.legacy.utils.HexConverter;
...
public class AriaModeVectorsTest2 {
  ...
  private static final byte[] CT_ECB =
      ByteUtils.fromHexString(
  ...
  private static final byte[] CT_CBC =
      ByteUtils.fromHexString(
  ...
  private static final byte[] CT_CFB128 =
      ByteUtils.fromHexString(
  ...
  private static final byte[] CT_CFB64 =
      ByteUtils.fromHexString(
          "3720e53ba7d61538595743814e943acc821a056e3c5fdb10eeaed5e2de03e5bb"
  ...
  private static final byte[] CT_CFB16 =
      ByteUtils.fromHexString(
  ...
  private static final byte[] CT_CFB8 =
      ByteUtils.fromHexString(
  ...
  private static final byte[] CT_OFB128 =
      ByteUtils.fromHexString(
  ...
  private static final byte[] CT_OFB64 =
      ByteUtils.fromHexString(
  ...
  private static final byte[] CT_OFB16 =
      ByteUtils.fromHexString(
  ...
  private static final byte[] CT_OFB8 =
      ByteUtils.fromHexString(
  ...
  private static final byte[] CT_CTR =
      ByteUtils.fromHexString(
  ...
  void simpleTestEncryptCbc() {
    ...
    final byte[] padded = ByteUtils.addPadding(plainTextBytes);
    ...
    final byte[] unpadded = ByteUtils.removePadding(decryptBytes);
